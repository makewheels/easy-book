...
**MongoDB Docker 容器:** 名称 `mongodb`, 镜像 `mongo:5.0.5`, root密码 `JwPHtPGZ6npQP4VZ`
...
docker exec mongodb mongosh -u root -p JwPHtPGZ6npQP4VZ --authenticationDatabase admin --eval '
  use(\"admin\");
