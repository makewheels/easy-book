...
client = MongoClient('mongodb://easy-book:REDACTED_APP_PW@10.0.20.14:27017/easy_book?authSource=admin')
db = client.easy_book
print('Database connected successfully')
"

# 备份数据库
mongodump --host 10.0.20.14:27017 --username easy-book --password REDACTED_APP_PW --authenticationDatabase admin --db easy_book --out /backup/$(date +%Y%m%d)
